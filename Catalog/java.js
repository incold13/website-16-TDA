...
let headerCatalogButtonMobile = document.getElementById('catalogMobile');
...
headerCatalogButton.addEventListener('click', headerCatalogOpenClose);
headerCatalogButtonMobile.addEventListener('click', headerCatalogOpenClose);